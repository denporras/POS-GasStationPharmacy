angular.module('newApp')
    .controller('adminProfileCtrl', ['$scope', '$http', '$rootScope', 'Encoder', 'config',
        function ($scope, $http, $rootScope, Encoder, config) {
            ...
            $scope.user = {};
            $http.get(config.ip + '/GasStationPharmacy/api/Employees/' + $rootScope.globals.currentUser.id)
            ...
            $scope.editProfile = function () {
                ...
                $http.put(config.ip + '/GasStationPharmacy/api/Employees/' + $rootScope.globals.currentUser.id, $scope.user)
                    .success(function (result) {
                        console.log(result);
