angular.module('newApp')
    .controller('ailmentsCtrl', ['$scope', '$location', 'pluginsService', '$http', 'config', function ($scope, $location, pluginsService, $http, config) {
        ...
        $scope.verifiedAdd = function () {
            ...
            $http.post(config.ip + '/GasStationPharmacy/api/Ailments', post_resquest)
        ...
        $scope.remove = function (index, index_aux) {
            ...
            if (confirm("Are you sure to delete this row?") == true) {
                ...
                $http.delete(config.ip + '/GasStationPharmacy/api/Ailments/' + $scope.items[i].id_ailment)
                    .success(function (result) {
                        console.log(result);
                    })
                    .error(function (data, status) {
